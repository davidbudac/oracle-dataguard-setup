...
./common/cleanup_nfs_artifacts.sh --all           # also remove config .env, the whole handoff set (.md/.html/.json/_tnsnames.ora/_jdbc.properties/_verify.sh), app-impact HTML
